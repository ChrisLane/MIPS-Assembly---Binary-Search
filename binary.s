...
searchList:
	# Print search item input instruction
	li $v0, 4 				# syscall 4 (print_str)
	la $a0, msg_searchList 	# argument: search item input string
	syscall					# print the search item input string
	...
	beqz $t0, exit			# if 0, exit the program
